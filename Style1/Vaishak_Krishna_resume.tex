...
\section{Experience}
  \resumeSubHeadingListStart
  \resumeSubheading
      {Computer Science Mentors (UC Berkeley)}{January 2022 -- May 2023}
      {Mentor}{Berkeley, California}
      \resumeItemListStart
        \resumeItem{Currently Teaching \textbf{Computer Architecture} concepts as a mentor to a group of students weekly. }
