...
\section{Experience}
  ...
  \resumeSubheading
    {Research}{June 2022 -- August 2022}
    {Research Assistant under Dr.Rajagopal Appavu (MD Anderson Cancer Center)}{Remote}
    \resumeItemListStart
      ...
      \resumeItem{Performed in-depth research paper reviews, greatly reducing error frequency and professor workload.}
  \resumeItemListEnd
    \resumeSubheading
      {Computer Science Mentors (UC Berkeley)}{January 2022 -- May 2022}
      {Mentor}{Berkeley, California}
      \resumeItemListStart
        \resumeItem{\textbf{Taught data structures concepts and mentored} a group of students weekly with a \textbf{4.5/5.0 effectiveness rating}.}
        \resumeItem{Co-led a task force and \textbf{taught} concepts of ``Git'' and ``GitHub'' to students.}
        \resumeItemListEnd
    \resumeSubheading
      {QBurst}{June 2021 -- July 2021}
      {Backend Software Engineer Intern}{Remote}
      \resumeItemListStart
      \resumeItem{Developed REST API methods for an internal tool to \textbf{securely} and easily access customer lead data in a SQL database.}
      \resumeItem{Worked with frontend developers to integrate the API into the mobile app and increase ad deployment efficiency.}
      \resumeItemListEnd
...
\section{Projects}
    ...
    \resumeProjectHeading
      ...
      \vspace{-13pt}
      \resumeProjectHeading
          {\textbf{Wordle Improved} $|$ \href{https://wordle-improve.web.app/}{\underline{https://wordlem.top}} $|$\emph{JavaScript, React, HTML/CSS, AWS}}{May 2022 - September 2022}
          \resumeItemListStart
      ...
      \resumeItemListStart
            ...
            \resumeItem{Designed a \textbf{novel version of Poker} to aid the development and debugging of the Texas hold-em solver.}
          \resumeItemListEnd 
          \vspace{-13pt}
      ...
      {\textbf{School Projects} $|$ \emph{Python, Java, C, Go}}{January 2020 - May 2022}
          ...
          \resumeItem{Developed an \textbf{optimization algorithm} in Python to achieve \textbf{5th place out of 220} in an algorithm competition.}
...
\section{Other Skills/Hobbies}
    ...
    \begin{itemize}
      ...
      \item{Hobbies - Computer Hardware, Poker Theory, Gaming, Weight Lifting, Rubik's cubing, Cooking }
    \end{itemize}
