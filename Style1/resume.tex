...
\begin{center}
    ...
    \small \raisebox{-0.1\height}\faPhone\ 908-l ~ \href{mailto:vaishak.krishna@berkeley.edu}{\raisebox{-0.2\height}\faEnvelope\  \underline{vaishak.krishna@berkeley.edu}} ~ 
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      {University of California, Berkeley}{Aug. 2020 -- Present}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Developed a REST API using the .NET framework and SQL server for easy access to customer lead data.}
        \resumeItem{Worked closely and efficiently with a UX designer to integrate the API into the mobile application.}
      \resumeItemListEnd
  \resumeSubHeadingListEnd
\vspace{-16pt}
...
\section{Projects}
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{WordleM} $|$ \href{https://wordlem.top}{\underline{https://wordlem.top}} $|$\emph{JavaScript, ReactJS, CSS, HTML, Linode}}{January 2021}
          \resumeItemListStart
            \resumeItem{Developed and published a responsive, improved version of the hit game ``Wordle'' using ReactJS, hosted in the cloud.}
            \resumeItem{Implemented a highly performant information-theory driven solver and helper with a $<$ 4 average guess rate.}
            \resumeItem{Maximized application responsiveness and endabled support for sharing on all devices using multiple Web APIs.}
            \resumeItem{Improved user statistics tracking by returning metrics such as skill/luck scores, average guess rate, and more.}
          \resumeItemListEnd
          \vspace{-13pt}
      \resumeProjectHeading
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: Python, JavaScript, C, C\#, Java, HTML, CSS, Scheme (LISP)} \\
     \textbf{Developer Tools}{: VS Code, IntelliJ, PyCharm, Eclipse, Visual Studio} \\
     \textbf{Technologies/Frameworks}{: ReactJS, GitHub, .NET, Django, Jyupiter Notebook} \\
    }}
 \end{itemize}
 \vspace{-16pt}
