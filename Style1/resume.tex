...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Developed a RESTful API using the .NET framework and SQL server for easy access to customer lead data.}
...
\section{Projects}
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{WordleM} $|$ \emph{JavaScript, ReactJS, CSS, HTML, Linode}}{January 2021}
          \resumeItemListStart
